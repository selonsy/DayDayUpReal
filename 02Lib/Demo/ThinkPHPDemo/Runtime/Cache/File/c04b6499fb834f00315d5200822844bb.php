...
<?php if(!empty($data)): ?><img src="/Uploads/m_<?php echo ($data["image"]); ?>" /> <img src="/Uploads/s_<?php echo ($data["image"]); ?>" /><?php endif; ?>
<form id="upload" method='post' action="/index.php/File/Index/upload/" enctype="multipart/form-data">
