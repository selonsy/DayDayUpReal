...
body {
  margin: 0;
  padding: 0;
  background: #DFDFDF url(/Public/Images/body_bg.gif) repeat-y ;
  cursor: E-resize;
}
</style>
...
<!--
var pic = new Image();
pic.src="/Public/Images/bar_open.gif";
...
function toggleMenu()
{
  ...
  {
    frmBody.cols="200, 7, *";
    imgArrow.src = "/Public/Images/bar_close.gif";
  }
  else
  {
    frmBody.cols="0, 7, *";
    imgArrow.src = "/Public/Images/bar_open.gif";
  }
}
...
<table height="100%" cellspacing="0" cellpadding="0" style="border-left:1px solid #BFBFBF;" id="tbl">
  <tr><td><a href="javascript:toggleMenu();"><img src="/Public/Images/bar_close.gif" width="6" height="60" id="img" border="0" /></a></td></tr>
</table>
</body>
</html>