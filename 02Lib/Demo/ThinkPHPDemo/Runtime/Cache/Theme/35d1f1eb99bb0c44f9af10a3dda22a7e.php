...
<html>
	...
	*{ padding: 0; margin: 0;font-size:16px; font-family: "微软雅黑"} 
    ...
    <body>
        <div class="main">
            <h2>ThinkPHP示例之：模板主题</h2>
            <div class="result" style="background:#CECEFF;border:1px solid black;color:red">这是think主题</div>
            切换到：<a href="?t=default">主题default</a>
        </div>
    </body>
</html>